...
/**
 * 
 * NOTE: This file defines how the header of a .simdb file works
 * 
 * /**
 * Formatted as such:
...
namespace SimDB {
   ...
   */
  constexpr int getHeaderTokenBitSize(const HeaderTokens::Token token, const unsigned int string_size = 0) {
